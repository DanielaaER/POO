...
public class Principal {
    ...
    public static void main(String[] args) {
        // TODO code application logic here
          Persona p1, p2, p3;
          p1=new Persona(llenarDatos("nombre"),llenarDatos("sexo").charAt(0), Double.valueOf(llenarDatos("peso")), Double.valueOf(llenarDatos("estatura")), Integer.valueOf(llenarDatos("edad")));
